...
export const SearchIcon = ({ color = '#989898', size = 24 }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const LikeIcon = ({ color = 'black', size = 32 }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const CartIcon = ({ color = 'black', size = 32 }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const UserIcon = ({ color = 'black', size = 32 }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const PhonesIcon = ({ color = "white", size = 32 }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const ComputersIcon = ({ color = 'white', size = 32 }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const SmartWatchesIcon = ({ color = 'white', size = 32 }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const CamerasIcon = ({ color = 'white', size = 32 }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const HeadphonesIcon = ({ color = 'white', size = 32 }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const GamingIcon = ({ color = 'white', size = 32 }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const HamburgerIcon = ({ color = "#080341", size = 32 }) => {
  return (
    <svg
      width={size}
      height={size}
